# Practice for AWS CodePipline from YouTube video https://www.youtube.com/watch?v=Buh3GjHPmjo
# Project on AWS is named express-app (express-app-pipeline and Deploy name of express-app-group).
